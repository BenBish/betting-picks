...
import { calculateClvPercent, calculateProfitLoss, calculateClvDirection } from './calculations';
...
describe('calculateClvDirection', () => {
  ...
  it('returns null when closing is undefined', () => {
    expect(calculateClvDirection(2.0, undefined as unknown as number | null)).toBeNull();
  });
});
